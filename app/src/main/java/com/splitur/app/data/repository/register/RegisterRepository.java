...
public class RegisterRepository {
    ...
    public MutableLiveData<RegisterModel> registerUser(String number, String name, String id, String url) {
        ...
        MutableLiveData<RegisterModel> RegisterModelMutableLiveData = null;
        ...
        try {
            ...
            MutableLiveData<RegisterModel> finalRegisterModelMutableLiveData = RegisterModelMutableLiveData;
            call.enqueue(new Callback<RegisterModel>() {
                @Override
                public void onResponse(@NonNull Call<RegisterModel> call, @NonNull Response<RegisterModel> response) {
                    if(response.body()!=null)
                    {
                        finalRegisterModelMutableLiveData.setValue(response.body());
